...
export function InstructorForm(props: Props) {
  const {
    name,
    setName,
    email,
        ...
        <div className="grid grid-cols-1 gap-4">
          <div>
            ...
            <Input
              ...
              placeholder="Insira o nome do instrutor"
              required
            />
          </div>
          ...
          <div className="relative">
            ...
            <div className="relative h-10">
              <Input
                ...
                onBlur={() => setTimeout(() => setPwFocused(false), 120)}
              ...
              <button
                ...
                className="absolute right-2 top-0 bottom-0 flex items-center justify-center px-2 text-slate-600 hover:text-slate-800 transition-colors"
          ...
          <div>
            ...
            <Input
              ...
              placeholder="Ex: Médico, psicólogo, neurocientista"
              required
            />
          </div>
          ...
          <div>
            ...
            <textarea
              ...
              value={about}
              onChange={(e) => {
                if (e.target.value.length <= 150) setAbout(e.target.value);
              }}
