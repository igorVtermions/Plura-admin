  ...
  return (
    <>
              ...
              <div className="flex flex-col gap-3" style={{ minHeight: 520 }}>
                <div className="max-w-[75%]" style={{ color: "#191F33" }}>
                  ...
                  >
                    ...
                    <div className="text-sm" style={{ marginTop: 4 }}>
                      Olá, sou Marta e tenho algumas dificuldades como ansiedade e autismo, você
                      poderia me ajudar?
                    </div>
                  </div>
                ...
                <div className="self-end flex flex-col items-end gap-2 max-w-[75%]">
                  <div
                    ...
                    style={{ background: "#977CEC", padding: 10 }}
                  >
      ...
      <Modal
        ...
        maxWidth="max-w-xl"
      >
        <div className="rounded-lg" style={{ background: "#F3F0FF", border: "1px solid #D4C7FF" }}>
          <div className="p-4">
            <div className="mb-3">
